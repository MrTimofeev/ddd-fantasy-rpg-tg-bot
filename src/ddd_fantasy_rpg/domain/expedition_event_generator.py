...
def generate_monster_for_distance(distance: ExpeditionDistance) -> Monster:
...
def generate_event_for_expedition(distance: ExpeditionDistance) -> MonsterEncounter:
    """
    Для MVP всегда генерируем монстра.
    Позже можно добавить веса: 70% монстр, 20% торговец, 10% ресурсы.
    """
    
    monster = generate_monster_for_distance(distance)
